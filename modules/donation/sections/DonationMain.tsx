const allocations = [
  ...
  { label: "Pengembangan Situs & Aksesibilitas", value: 25 },
  { label: "Konten Edukasi", value: 15 },
  { label: "Acara Komunitas Disabilitas", value: 10 },
        ...
        <div className="motion-fade-up flex flex-col justify-between gap-6 md:flex-row md:items-end">
          <div>
            <h2 className="text-4xl font-extrabold tracking-tight">
              Ke Mana Dukunganmu Berjalan?
            </h2>
            <p className="mt-4 max-w-3xl text-base leading-7 text-[#8aa4c1]">
              Kami berkomitmen mengelola dukungan secara terbuka. Dana yang
              terkumpul digunakan untuk membantu kerja redaksi, produksi
              konten, pengembangan situs, dan edukasi publik.
            </p>
          </div>
          <div className="text-left md:text-right">
            <p className="text-sm font-extrabold">Target 2026</p>
