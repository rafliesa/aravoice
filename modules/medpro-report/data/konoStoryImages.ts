// Plain data file — no "use client" needed, safe to import from server components
...
export const konoStoryImages: StoryImage[] = [
  {
    src: "/photo-story/1.jpeg",
    alt: "Atlet angkat beban National Paralympic Committee of Indonesia (NPCI) Kota Bandung, Ono Saefudin (bawah) , berlatih bench press untuk persiapan Peparda di GOR Pajajaran, Kota Bandung, Jawa Barat pada 19 Juli 2026.",
    caption:
  ...
  },
  {
    ...
    alt: "Atlet angkat beban National Paralympic Committee of Indonesia (NPCI) Kota Bandung, Ono (Kiri), sedang dipijat oleh rekannya sebelum latihan  di GOR Pajajaran, Kota Bandung, Jawa Barat pada 19 Juli 2026.",
    caption:
      "Meski ia menyadari bahwa umurnya sudah tidak muda dan tubuhnya kian menua, baginya angkat beban bukan lah perihal mudah untuk ditinggalkan. Pertemuannya dengan cabang olahraga ini berawal pada 9 tahun lalu. Ono memang sudah aktif berolahraga sejak muda.\n\n\u201cPerjalanan saya menjadi atlet angkat berat itu karena sebelumnya saya memang senang fitness. Tahun 2018 saya baru tahu bahwa ada olahraga angkat berat khusus disabilitas di NPCI Kota Bandung. Dari situ saya masuk ke cabang olahraga angkat berat.\u201d ungkapnya.\n\nDalam dunia barunya inilah, Ono menemukan kembali sepenggal lain bagian hidupnya. Baginya angkat berat bukan sekedar olahraga kompetitif, melainkan arena refleksi diri untuk terus menatap masa depan. \u201cTantangannya banyak (pada cabang olahraga ini). Yang paling besar itu mengalahkan diri sendiri.\u201d",
  },
  {
    src: "/photo-story/gym.jpeg",
  ...
  },
  {
    ...
    alt: "Atlet angkat beban National Paralympic Committee of Indonesia (NPCI) Kota Bandung, Ono (kiri), dan Istrinya, Rohayati (kedua kiri), berkendara dengan motor modifikasi roda tiganya  menyusuri jalanan Kota Bandung menuju lokasi kebunnya di Kompleks Dinas Sosial Jawa Barat, Kota Cimahi, Kota Bandung, Jawa Barat pada 20 Juli 2026.",
    caption:
  ...
  },
  {
    ...
    alt: "Umbi-umbian hasil atlet angkat beban National Paralympic Committee of Indonesia (NPCI) Kota Bandung, Ono yang dipanen dari kebun kebun di Kompleks Dinas Sosial Jawa Barat, Kota Cimahi, Kota Bandung, Jawa Barat yang Ia rawat bersama kelompok taninya pada 20 Juni, 2026",
    caption:
  ...
  },
  {
    ...
    alt: "Istri Ono, Rohayati, memasak hasil panen kebun di Kompleks Dinas Sosial Jawa Barat, Kota Cimahi, Kota Bandung, Jawa Barat pada 20 Juli 2026.",
    caption:
      "Ono selalu menegaskan pentingnya ketahanan pangan dari lingkup terkecil. Menanam bukan hanya soal menuai, tapi tentang menghidupi.\n\n\Selain internalisasi nilai-nilai tani yang ia terapkan di keluarganya, Ono juga kerap menginternalisasikan filosofi pertanian dalam kariernya sebagai seorang atlet. Ono menganggap bahwa manusia tidak berbeda dengan tanaman. Baginya  hasil tidak lahir dari ruang hampa, namun dari berbagai perawatan, perhatian, dan usaha yang rutin dikerahkan setiap harinya.",
  },
  {
    src: "/photo-story/8.jpeg",
    alt: "Atlet angkat beban National Paralympic Committee of Indonesia (NPCI) Kota Bandung, Ono (tengah), berpose dengan dua medali Perunggu Pekan Paralimpik Daerah (Peparda) Kabupaten Bekasi 2022 bersama Istrinya, Rohayati (Kanan) dan Putri mereka (Kiri) di rumahnya di Kota Bandung, Jawa Barat, pada 19 Juni, 2026.",
    caption:
