  ...
  return (
    <>
      <p className={articleParagraphClass} key="paragraph-0">
        {"Bagi sebagian atlet, medali tidak hanya berarti prestasi. Di baliknya terdapat bonus, uang pembinaan, hingga peluang untuk kembali dipanggil demi memperkuat daerah dalam kompetisi selanjutnya. Karena itu, setiap pertandingan tidak hanya menjadi ajang pembuktian kemampuan,"}
      </p>
      ...
      <p className={articleParagraphClass} key="paragraph-4">
        {"Psikolog klinis yang pernah mendampingi atlet disabilitas di ASEAN Para Games 2018."}
      </p>
      ...
      <p className={articleParagraphClass} key="paragraph-6">
        {"Tekanan itu tidak berdiri sendiri. Pada beberapa atlet, beban mental justru datang dari luar arena."}
      </p>
      ...
      <p className={articleParagraphClass} key="paragraph-10">
        {"Untuk mengatasi masalah tersebut, Kono memiliki pekerjaan lain di luar olahraga, yaitu bertani konvensional dan hidroponik serta membuka pengobatan alternatif di rumah. Ia mengaku,"}
      </p>
      <p className={articleParagraphClass} key="paragraph-11">
        {"penghasilan dari usaha itu tidak selalu stabil, tidak jauh berbeda dari penghasilannya sebagai atlet. Namun dalam waktu yang bersamaan, Kono menyatakan bahwa ketidakstabilan tersebut tetap menjadi beban."}
      </p>
      ...
      <p className={articleParagraphClass} key="paragraph-16">
        {"Ketika prestasi menjadi peluang pendapatan lebih, hal ini memberikan tekanan psikologis para atlet untuk terus meraih medali di ajang pertandingan. Tekanan ini sangat memengaruhi performa atlet saat latihan maupun kompetisi. Menurut Yulia, pengaruh mental terhadap performa atlet saat bertanding bisa mencapai 80 persen. Bahkan saat semua persiapan sudah dilakukan selama latihan, masih ada atlet yang mengkhawatirkan kekalahan yang belum tentu terjadi."}
      </p>
      <h2 className={articleHeadingClass} key="heading-17">
        {"STIGMA MEMENGARUHI KONDISI PSIKOLOGIS ATLET"}
      </h2>
      <p className={articleParagraphClass} key="paragraph-18">
        {"Selain tekanan ekonomi, tekanan sosial juga menjadi bagian dari beban psikologis atlet disabilitas. Jonna menyebut stigma sebagai tantangan berat dalam isu disabilitas. Menurutnya,"}
      </p>
      ...
      <p className={articleParagraphClass} key="paragraph-22">
        {"Bagi atlet, stigma itu bisa muncul dalam komentar sederhana yang mempertanyakan kemampuan mereka. Randi, atlet bulu tangkis NPCI Kota Bandung, pernah mengalami tekanan semacam itu."}
      </p>
      ...
      <MediaPlaceholder assetNumber={1} key="media-30" text={"Video aksesibilitas trotoar, guiding block, pot besar, dan parkir kendaraan"} />
      <h2 className={articleHeadingClass} key="heading-30">
        {"SUB PSIKOLOG YANG MASIH DIPANDANG SEBELAH MATA"}
      </h2>
      ...
      <p className={articleParagraphClass} key="paragraph-38">
        {"NPCI Kota Bandung sendiri tidak memiliki psikolog atau layanan psikologis khusus para atlet."}
      </p>
      <p className={articleParagraphClass} key="paragraph-39">
        {"Djumono menyebutkan bahwa psikolog biasanya disiapkan saat event besar seperti Peparda melalui kerja sama dengan Dinas Kesehatan dan tim kontingen. Namun, di luar momen event besar, beberapa pelatih dan pendamping menyebut pendampingan khusus belum terlihat rutin."}
      </p>
