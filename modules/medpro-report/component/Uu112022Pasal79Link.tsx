...
export default function Uu112022Pasal79Link({ children }: { children: React.ReactNode }) {
  ...
  return (
    <>
      <a
        href="#legal-reference-dialog-11-2022-79"
        onClick={(event) => {
          event.preventDefault();
          setIsOpen(true);
        }}
      ...
      {isOpen && (
        ...
        >
          <section
            id="legal-reference-dialog-11-2022-79"
            role="dialog"
            aria-modal="true"
            aria-labelledby="legal-dialog-title-11-79"
            aria-describedby="legal-dialog-description-11-79"
          ...
          >
            <div className="bg-primary flex items-start justify-between gap-6 px-6 py-5 text-white sm:px-8">
              <div>
                ...
                <h2 id="legal-dialog-title-11-79" className="mt-2 text-xl font-bold">
                  UU No. 11 Tahun 2022 Pasal 79
                </h2>
              </div>
              <button
                ref={closeButtonRef}
            ...
            <div className="p-6 sm:p-8 space-y-4">
              <p className="text-secondary-700 text-xs font-extrabold uppercase tracking-[0.14em]">
                Pendanaan Keolahragaan & Dana Hibah
              </p>
              ...
              <div className="space-y-4 text-base leading-8 text-[#0a3358] font-sans border-l-4 border-secondary-500 pl-4 bg-zinc-50 p-4 rounded-r-xl">
                <p id="legal-dialog-description-11-79">
                  <strong>Ayat (1):</strong> Pemerintah Daerah provinsi dan Pemerintah Daerah kabupaten/kota mengalokasikan anggaran untuk pendanaan Keolahragaan dari anggaran pendapatan dan belanja daerah sesuai dengan kemampuan keuangan daerah dan mempertimbangkan target capaian pelaksanaan desain besar Olahraga nasional yang menjadi kewenangan Pemerintah Daerah.
                </p>
                <p>
                  <strong>Ayat (2):</strong> Alokasi anggaran sebagaimana dimaksud pada ayat (1) dapat disalurkan kepada komite olahraga nasional di provinsi dan komite olahraga nasional di kabupaten/kota melalui pemberian hibah yang dilaksanakan sesuai dengan ketentuan peraturan perundang-undangan.
                </p>
              </div>
