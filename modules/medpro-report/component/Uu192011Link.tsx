...
export default function Uu192011Link({ children }: { children: React.ReactNode }) {
  const [isOpen, setIsOpen] = useState(false);
  const closeButtonRef = useRef<HTMLButtonElement>(null);
  const OFFICIAL_LAW_URL = "https://peraturan.bpk.go.id/Details/39097/uu-no-19-tahun-2011";
  ...
  return (
    <>
      <a
        href="#legal-reference-dialog-19-2011"
        onClick={(event) => {
          event.preventDefault();
          setIsOpen(true);
        }}
      ...
      {isOpen && (
        ...
        >
          <section
            id="legal-reference-dialog-19-2011"
            role="dialog"
            aria-modal="true"
            aria-labelledby="legal-dialog-title-19"
            aria-describedby="legal-dialog-description-19"
          ...
          >
            <div className="bg-primary flex items-start justify-between gap-6 px-6 py-5 text-white sm:px-8">
              <div>
                ...
                <h2 id="legal-dialog-title-19" className="mt-2 text-xl font-bold">
            ...
            <div className="p-6 sm:p-8">
              ...
              <p
                id="legal-dialog-description-19"
                className="mt-4 text-base leading-8 text-zinc-700"
              >
                Peraturan ini mengesahkan Konvensi Mengenai Hak-Hak Penyandang Disabilitas,
                sebagai bagian dari komitmen Indonesia dalam menjamin hak-hak penyandang disabilitas
                berdasarkan prinsip persamaan, perlindungan hukum, dan pemenuhan hak asasi manusia.
              </p>
              ...
              <dl className="mt-6 grid gap-4 rounded-xl bg-zinc-50 p-5 sm:grid-cols-3">
                <div>
                  ...
                  <dd className="mt-1 font-bold">10 November 2011</dd>
                </div>
                <div>
                  <dt className="text-xs font-bold uppercase text-zinc-500">
                    Status
